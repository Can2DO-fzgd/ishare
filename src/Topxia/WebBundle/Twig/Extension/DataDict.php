...
class DataDict
{
	private static $dict = array(
		...
		'orderStatus:html' => array(
			'created' => '<span class="text-muted">未关注</span>',
			'paid' => '<span class="text-success">已关注</span>',
			'refunding' => '<span class="text-warning">取消中</span>',
            'refunded' => '<span class="text-danger">已取消</span>',
		...
		'refundStatus:html' => array(
			...
			'success' => '<span class="text-success">取消成功</span>',
			'failed' => '<span class="text-danger">取消失败</span>',

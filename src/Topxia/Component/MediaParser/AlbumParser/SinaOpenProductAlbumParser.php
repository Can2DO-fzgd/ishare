...
class SinaOpenProductAlbumParser extends AbstractAlbumParser
{
	private $patterns = array(
		'p1' => '/^http:\/\/open.sina.com.cn\/product\/id_(\d+)/s',
	);
	...
	public function parse($url)
	{
        ...
        $album['uuid'] = 'SinaOpenProductAlbum:' . $album['id'];

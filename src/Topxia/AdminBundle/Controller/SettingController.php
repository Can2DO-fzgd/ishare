...
class SettingController extends BaseController
{
    ...
    public function userCenterAction(Request $request)
    {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            $setting = array('mode' => $data['mode'],
                            'userName_enabled' => $data['userName_enabled'],
    ...
    public function adminSyncAction(Request $request)
    {
        ...
        if ($request->getMethod() == 'POST') {
            $data = $request->request->all();
            $partnerUser = $this->getAuthService()->checkPartnerLoginByUserName($data['userName'], $data['password']);
            if (empty($partnerUser)) {
                ...
                $this->getUserService()->changeUserName($currentUser['id'], $partnerUser['userName']);
